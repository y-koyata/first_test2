...
2. **イベント説明・メールアドレス入力**
   ...
   - 申し込み（または変更）を希望するメールアドレスを入力し、**reCAPTCHA判定を経て**送信。
3. **重複チェックと認証メール送信**
...
- **2026/01/12**: キャンペーン（イベント）への画像アップロード機能を追加。管理画面で画像を登録し、申し込みページに表示できるように改修。
